...
export const MODELS: Record<string, ModelConfig> = {
  ...
  pages: {
    ...
    titleField: 'titleUz',
    emptyHint:
      'Biz haqimizda, ommaviy oferta, maxfiylik siyosati — matni kamdan-kam o‘zgaradigan sahifalar.',
    sections: [
      {
        title: 'Sahifa matni',
        hint: 'Sarlavha va matn. Manzil (slug) sayt kodiga bog‘langan — ehtiyot bo‘lib o‘zgartiring.',
        locked: true,
        fields: [
          { name: 'title', label: 'Sarlavha', type: 'text', bilingual: true, required: true },
          {
      ...
      {
        title: 'Manzil va SEO',
        hint: 'Slug saytdagi yo‘lga mos bo‘lishi kerak: biz-haqimizda, ommaviy-oferta, maxfiylik-siyosati.',
        fields: [
          {
            name: 'slug',
            label: 'Sahifa manzili',
            ...
            required: true,
            slugFrom: 'titleUz',
            hint: 'Mavjud sahifani tahrirlayotgan bo‘lsangiz — O‘ZGARTIRMANG',
            inTable: true,
          },
          ...SEO_FIELDS,
        ],
