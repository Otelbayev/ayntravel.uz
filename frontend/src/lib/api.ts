...
/**
 * `next build` paytida ishlayapmizmi.
 *
 * Next bu o'zgaruvchini build jarayonida o'zi o'rnatadi. Bizga u faqat
 * bitta narsa uchun kerak: build vaqtida API'ga yetib bo'lmasa, sahifa
 * butun build'ni to'xtatib qo'ymasligi kerak (pastdagi izohga qarang).
 */
export const isBuildPhase = process.env.NEXT_PHASE === 'phase-production-build';

/**
 * Xato API javob bermagani uchunmi (tarmoq darajasidagi nosozlik), yoki
 * API javob berib, lekin xato kod qaytardimi?
 *
 * `ApiError` — API javob berdi (404, 400, 500...). Boshqa har qanday xato
 * `fetch` ning o'zi ishlamaganini bildiradi: server o'chiq (ECONNREFUSED),
 * DNS topilmadi, vaqt tugadi.
 */
