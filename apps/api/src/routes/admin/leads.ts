...
import { formatUzPhone, leadQuerySchema, updateLeadSchema } from '@ayntravel/shared';
...
adminLeadsRouter.patch(
  ...
  asyncHandler(async (req, res) => {
    const body = req.body as { status?: import('@ayntravel/shared').LeadStatus; managerNote?: string };
